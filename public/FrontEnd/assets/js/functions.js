...
19 DROPZONE
20 FAKE PASSWORD
21 FAKE CONFIRM PASSWORD
22 AUTO TAB
23 GUEST SELECTOR
24 PARALLAX BACKGROUND
25 OVERLAY SCROLLBAR
26 TRAFFIC CHART
27 TRAFFIC CHART 2
28 TRAFFIC CHART 3
29 TRAFFIC CHART 4
...
var e = {
    ...
    // START: 21 FAKE CONFIRM PASSWORD
    fakePwdConfirm: function () {
      if (e.isVariableDefined(e.select('.fakepassword-confirm'))) {
        var password = document.querySelector('.fakepassword-confirm');
        var toggler = document.querySelector('.fakepassword-icon-confirm');
