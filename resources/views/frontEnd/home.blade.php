	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-10 ms-auto position-relative">
				<img src="{{ asset('FrontEnd/assets/images/bg/03.jpg') }}" class="rounded-3" alt="">
		...
		<div class="row g-4">
			...
			<div class="col-sm-4 col-xl-2">
				<div class="card shadow text-center align-items-center h-100 p-4">
					...
					<div class="icon-xxl bg-light rounded-circle">
						<img src="{{ asset('FrontEnd/assets/images/category/cab/seadan.svg') }}" class="w-90px" alt="">
					</div>
					<!-- Card body -->
			...
			<div class="col-sm-4 col-xl-2">
				<div class="card shadow text-center align-items-center h-100 p-4">
					<!-- Image -->
					<div class="icon-xxl bg-light rounded-circle">
						<img src="{{ asset('FrontEnd/assets/images/category/cab/micro.svg') }}" class="w-90px" alt="">
					</div>
					<!-- Card body -->
					<div class="card-body px-0 pb-0">
			...
			<div class="col-sm-4 col-xl-2">
				<div class="card shadow text-center align-items-center h-100 p-4">
					<!-- Image -->
					<div class="icon-xxl bg-light rounded-circle">
						<img src="{{ asset('FrontEnd/assets/images/category/cab/suv-2.svg') }}" class="w-90px" alt="">
					</div>
					<!-- Card body -->
					<div class="card-body px-0 pb-0">
			...
			<div class="col-sm-4 col-xl-2">
				<div class="card shadow text-center align-items-center h-100 p-4">
					<!-- Image -->
					<div class="icon-xxl bg-light rounded-circle">
						<img src="{{ asset('FrontEnd/assets/images/category/cab/suv.svg') }}" class="w-90px" alt="">
					</div>
					<!-- Card body -->
					<div class="card-body px-0 pb-0">
			...
			<div class="col-sm-4 col-xl-2">
				<div class="card shadow text-center align-items-center h-100 p-4">
					<!-- Image -->
					<div class="icon-xxl bg-light rounded-circle">
						<img src="{{ asset('FrontEnd/assets/images/category/cab/pickup.svg') }}" class="w-90px" alt="">
					</div>
					<!-- Card body -->
					<div class="card-body px-0 pb-0">
			...
			<div class="col-sm-4 col-xl-2">
				<div class="card shadow text-center align-items-center h-100 p-4">
					<!-- Image -->
					<div class="icon-xxl bg-light rounded-circle">
						<img src="{{ asset('FrontEnd/assets/images/category/cab/coupe.svg') }}" class="w-90px" alt="">
					</div>
					<!-- Card body -->
					<div class="card-body px-0 pb-0">
