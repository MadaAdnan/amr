        ...
        <div class="offcanvas-body p-3 p-lg-0">
            <div class="card bg-light w-100">
                ...
                <div class="position-absolute top-0 end-0 p-3">
                    <a href="{{ route('frontEnd.user.profile.home') }}" class="text-primary-hover" data-bs-toggle="tooltip" data-bs-title="Edit profile">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="text-center mb-3">
                        ...
                        <div class="avatar avatar-xl mb-2">
                            <img class="avatar-img rounded-circle border border-2 border-white"  src="{{ auth()->user()->image }}" alt="user profile" onerror="this.onerror=null;this.src='{{ asset('FrontEnd/assets/images/element/avatar-placeholder.jpg') }}';">
                        </div>
                    ...
                    <ul class="nav nav-pills-primary-soft flex-column">
                        <li class="nav-item">
                            <a class="nav-link {{ $activeNavItem == 'my-profile' ? 'active' : '' }}" href="{{ route('frontEnd.user.profile.home') }}"><i class="bi bi-person fa-fw me-2"></i>My Profile</a>
                        </li>
                        <li class="nav-item">
