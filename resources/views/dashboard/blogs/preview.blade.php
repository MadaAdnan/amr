        ...
        <div class="row">
            <div class="col-lg-3 sidebar-blog">
                ...
                <div class="widget stick">
                    <a href="{{ route('dashboard.blogs.edit',$data->id) }}" class="widget-title">Back to Edit</a>
                </div>
                <div class="widget stick">
            ...
            <div class="col-lg-7 blog-single">
                <article class="post-entry">
                    ...
                    <div id="section1" class="post-content">
                        ...
                        <hr/>
                        <div id="blog-content" class="description2">
                            @if ($data->content)
                                {!! $data->content !!}
                                @else 
                                No Content
...
<script>
    ...
    for (var i = 0; i < h2Elements.length; i++) {
        ...
        $('#table-content-list').append(`<li style="direction:ltr"><a href="#${h2Elements[i].textContent}"  style="direction:ltr;"> ${h2Elements[i].textContent.replace(/<[^>]+>/g, '')}</a><li/>`)
    }
