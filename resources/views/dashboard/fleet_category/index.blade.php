...
<div class="page-title">
    ...
    <div class="card">
        <div class="row" id="basic-table">
            <div class="col-12">
                <div class="row p-4">
                    <h4 class="w-50 font-weight-bold">Fleets Category</h4>
                    <div class="w-50 text-right">
                        <a href="{{ route('dashboard.fleetCategories.create') }}" type="button" class="btn btn-primary remove-border w-50">Add</a>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-bold-500 text-center"><span class="badge badge-success {{ $item->status == '1'?'success-badge':'danger-badge' }} text-uppercase">{{$status[$item->status]['name']}}</span></td>

                                    <td class="text-bold-500 text-center">
                                        <a href="{{ route('dashboard.fleetCategories.edit',$item->id) }}" class="btn btn-primary btn-sm custom-button"><i data-feather="eye" width="20"></i></a>
                                    </td>
                                </tr>
                                @endforeach
