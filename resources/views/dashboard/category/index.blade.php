...
<div class="page-title">
    ...
    <div class="card">
        <div class="row" id="basic-table">
            <div class="col-12">
                <div class="row p-4">
                    <h4 class="w-50 font-weight-bold">Categories</h4>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-bold-500">{{ $item->posts()->where('status','publish')->count() }}</td>
                                    <td class="text-bold-500 text-center">
                                        <button onclick="deleteCategory('{{ $item->id }}')" class="btn btn-danger btn-sm custom-button delete-red"> <i data-feather="trash" width="20"></i> </button>
                                        <button onclick="openModal('edit',`{{ json_encode($item) }}`)" class="btn btn-dark text-white btn-sm custom-button"><i data-feather="edit" width="20"></i></button>
                                    </td>
                                </tr>
                                @endforeach
