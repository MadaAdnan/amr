...
img.card-img-top {
    ...
    <form enctype="multipart/form-data" action="{{ route('dashboard.events.store') }}" id="AddForm" method="post">
        @csrf
         <div class="card p-3">
            <div class="container">
            ...
            <hr/>
                  <div class="row mb-4">
                    <div class="col-6">
                        <div>
                            ...
                            <input required name="event_name" type="text" class="form-control" id="event_name">
                        </div>
                    </div>
                    <div class="col-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-10">
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <input disabled required name="place_name" type="text" class="form-control" id="place_name" placeholder="Enter place name">
                                </div>
                                <div class="col-2">
                    ...
                    <div class="col-2 justify-content-end">
                        ...
                        <input required onkeyup="updateRadius()" name="radius" type="number" class="form-control" id="radius">
                  ...
                  <div class="row mt-5">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input required disabled name="lat" type="text" class="form-control" id="lat">
                          </div>
                    </div>
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="long" class="form-label">Long</label>
                            <input required disabled name="long" type="text" class="form-control" id="long">
                          </div>
                    </div>
                  </div>
                  ...
                  <div class="row mb-5">
                    <div class="col-6">
                        ...
                        <input required id="startDate" onchange="setEndDate()" name="start_date" type="date" class="form-control">
                    </div>
                    <div class="col-6">
                        <label for="radius" class="form-label">End Date</label>
                        <input required disabled id="endDate" type="date" name="end_date" class="form-control" >
                    </div>
                  </div>
                  <div class="row mb-5">
                    <div class="col-6">
                  ...
                  <div class="row">
                    ...
                    <div id="priceDiv" class="col-6">
                        <label for="radius" class="form-label">Price</label>
                        <input id="price" required min="1" type="number" class="form-control">
                    </div>
                    <div id="percentageDiv" class="col-6" style="display: none;">
                        <label for="radius" class="form-label">Percentage</label>
                        <input name="percentage" id="percentage" required min="1" max="100" type="number" class="form-control">
                    </div>
                    <div class="col-6 mb-3">
    ...
    <script>
       ...
       function updateRadius()
        ...
        function collectAndSendData(form)
        {
            ...
            const request = '{{ route("dashboard.events.store") }}';
