...
<div class="page-title">
    ...
    <div class="card">
        <div class="row" id="basic-table">
            <div class="col-12">
                <div class="row p-4">
                    <h4 class="w-50 font-weight-bold">Ads</h4>
                    <div class="w-50 text-right">
                        <a href="{{ route('dashboard.ads.create') }}" type="button" class="btn btn-primary create-hover remove-border">Create</a>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-bold-500 text-center">
                                        <a href="{{ route('dashboard.ads.edit',$item->id) }}" class="btn btn-dark text-white btn-sm custom-button"><i data-feather="edit" width="20"></i></a>
                                    </td>
                                </tr>
                                @endforeach
