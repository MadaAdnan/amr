                ...
                <div class="row  flex-row">
                    <div class="col-md-6">
                        <div class="form-group  p-3">
                            ...
                            <input class="form-control" name="service_type" id="service_type" value="{{ isset($reservation->serviceType)?$reservation->serviceType->service_name : ''}}"disabled>
                    ...
                    <div class="col-md-6">
                        <div class="form-group  p-3">
                            ...
                            <select class="form-control" id="fleet" name="category_id"disabled>
                                @if (isset($fleetCategory) && count($fleetCategory) > 0)
                                    @foreach ($fleetCategory as $fleet)
...
@section('scripts')
    <script>
     ...
     <script>
         ...
         // Replace 'your-nodejs-server-url' with your actual Node.js server URL.
         
         const reservationId = {{ $reservation->id }}; // Retrieve the reservation ID from your Laravel controller.
         const sender = "{{ $user->full_name }}";

         socket.emit('reservation', reservationId);
         ...
         sendButton.addEventListener('click', () => {
             ...
             socket.emit('sendMessage', { reservationId, message, sender });
             messageInput.value = '';
         });
         ...
         socket.on('newMessage', (data) => {
             ...
             messageElement.textContent =sender+":"+data;
