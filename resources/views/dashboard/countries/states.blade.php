...
<div class="page-title">
    ...
    <div class="card">
        <div class="row" id="basic-table">
            <div class="col-12">
                <div class="row p-4">
                    <h4 class="w-50 font-weight-bold">States for "{{ $country->name }}"</h4>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-bold-500 text-center">
                                        <a class="btn btn-primary btn-sm custom-button" href="{{ route('dashboard.countries.cities_index',$item->id) }}"><i data-feather="eye" width="20"></i></a>
                                    </td>
                                </tr>
                                @endforeach
        ...
        <div class="modal-body">
            <div class="form-group mb-3">
                ...
                <select onchange="getStateAccordingToState(event)" id="selectCountry" class="form-control">
                    <option data-country-name="{{ $country->name }}" value="{{ $country->id }}" selected>{{ $country->name }}</option>
                </select>
              </div>
              <div class="form-group mb-3">
