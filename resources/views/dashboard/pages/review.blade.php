...
@php
        ...
        $status = [
            ...
            'Pending'=>'Pending',
            'Rejected'=>'Rejected',
            'Published'=>'Admin reject',
        ]
@endphp
    <form enctype="multipart/form-data" action="{{ route('dashboard.pages.release',$data->id) }}" id="AddForm" method="post">
        @csrf
            <div class="row">
                <div class="col-9">
                    @if ($data->reject_note)
                    ...
                    <div class="p-3">
                            ...
                            <div class="input-group mb-2">
                              <div class="input-group-prepend">
                                <div class="input-group-text">https://blog.lavishride.com/blogs/</div>
                              </div>
                ...
                <div class="col-3">
                    ...
                    <div class="card">
                        <div class="col d-flex">
                            <button disabled class="btn btn-secondary m-2 w-100">Preview</button>
                        </div>
                    </div>
                    @permission('publish-web-pages')
                    ...
                    <div class="card p-3">
                        <div class="form-group">
                           ...
                           <input value="{{ $data->seo_title }}" name="seo_title" class="form-control" />
                        </div>
                    </div>
...
@section('scripts')
    <script>
            ...
            function sendRjectNote()
            {
                ...
                let request = '{{ route("dashboard.pages.send_reject_note",$data->id) }}'
                $.ajax({
                    url:request,
                    data:{
                        '_token':'{{ csrf_token() }}',
